...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(msg.sender == _owner, 'sender does not own the contract');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != currentOwner, 'can only approve if you are not the owner');
        require(msg.sender == currentOwner || isApprovedForAll(currentOwner, to), 'caller is not authorized');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal virtual{
        ...
        require(_tokenOwner[tokenId] == from, 'you cannot transfer from this address (not the owner)');
        require(to != address(0), 'transfer to an invalid address');
